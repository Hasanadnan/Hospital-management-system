												...
												<div class="panel-body">
													...
													<form role="form" name="book" method="post" >
														...
														<div class="form-group">
															...
															<select name="doctor" class="form-control" id="doctor" onChange="{getfee(this.value); getday(this.value);};" required="required">
														...
														<div class="form-group">
															...
															<select name="day" class="form-control" id="day"  readonly>
